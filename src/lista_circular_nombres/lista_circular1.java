 ...
 * @author R0GV3
 */
public class lista_circular1 {
    
    // Puntero que indica el inicio de la lista o conocida tambien
    // como cabeza de la lista.
    private Nodo_lc1 inicio;
    // Puntero que indica el final de la lista o el ultimo nodo.
    private Nodo_lc1 ultimo;
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                if (aux == ultimo) {
                    ...
                    Nodo_lc1 siguiente = aux.getSiguiente();
    ...
    ///////   revisar para introducir texto
    public int gettexto(int posicion) throws Exception{
        // Verifica si la posición ingresada se encuentre en el rango
        // >= 0 y < que el numero de elementos del la lista.
        if(posicion>=0 && posicion<tamanio){
            // Consulta si la posicion es el inicio de la lista.
